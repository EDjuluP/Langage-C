...
int puissance(int x, int y); // d�claration-prototype de la fonction puissance
...
void affiche(int *t); // d�claration-prototype de la fonction affiche
...
float min(float *tab); // d�claration-prototype de la fonction min
...
float max(float *tab); // d�claration-prototype de la fonction max
...
int euclide(int a, int b); // d�claration-prototype de la fonction euclide
...
unsigned int factoriel(unsigned int n); // d�claration-prototype de la fonction factoriel
...
void inverse(char *ch); // d�claration-prototype de la fonction void inverse
