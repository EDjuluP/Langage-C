...
int main(int argc, char ** argv)
{
	...
	// Renvoyer ce que contient le tableau apr�s le tris
	...
	*/
	...
	/// M�thode choisie : tri par s�lection

	// D�finition du tableau + Variables
	int tab[20];
	int i, j, a, temp;

	srand(time(NULL)); // D�finition s�quence pseudo-al�atoire
